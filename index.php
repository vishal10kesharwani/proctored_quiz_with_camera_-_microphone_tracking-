...
<div class="jumbotron text-center">
  <h1>Online Proctored Examination</h1> 
  <p>e-EXAMINATION</p> 
  <!--  form>
...
<div class="container-fluid bg-grey">
  <div class="row">
    ...
    <div class="col-sm-8">
      <center><h2>Our Values</h2><br><center>
...
<fieldset>
 <h6 class="card-text" style="color:black;text-align:left;">Click A Snapshot using Below Given Button for Better Comparing Your Face While Proctored Quiz</h6><br>
 <div>
    <center> <canvas  id="myCanvas" width="280" height="200"></canvas></center>
     </div><br><center><div id="text" ></div></center>
<div id="container">
	<video autoplay="true" id="videoElement">
	 
	</video><br>
   <center><div> <button onclick="snapshot()">Take Snapshot</button></div></center>
...
function myFunction2() {
  document.getElementById("text").innerHTML = "Snap Captured Successfully";
}
</script>
<br><br>
<!-- Text input-->
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good iniative. I am so happy with the result!"<br><span></span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span></span></h4>
      </div>
      <div class="item">
        <h4>"Could I... BE any more happy with this startup"<br><span></span></h4>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 12345678790 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> gpgondia@gmail.com</p>
    </div>
...
<script>
function myMap() {
var myCenter = new google.maps.LatLng(21.4364626, 80.1992145);
